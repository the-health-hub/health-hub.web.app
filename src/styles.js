...
export const colorTertiary2 = '#ededed'; // Lighter grey
export const colorTertiary3 = '#f6f6f6'; // Lighter, lighter grey
...
export const textHover = colorTertiary;
...
export const seriesB = '#fbcb35';
export const seriesC = '#78d237';
export const seriesD = '#26c4db';
export const seriesE = '#3373ec';
export const seriesF = '#c03edb';
